...
\begin{enumerate}
\item Features on a bigger scale dominate distance calculations. Spend vs weekly visit count for customer segmentation.
...
\]
where $s_x$ is the standard deviation of variable $x$. Remind of standard deviation calculation.
...
\begin{enumerate}
\item IDM 2.3, 2.4, 2.1-2.2 recommended
\end{enumerate}
